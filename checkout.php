...
<body>
      ...
      <div  class="form">
    		<form id="contactform" method="post"> 
    			...
    			<input id="pc" name="pc" placeholder="AB" required="" tabindex="2" type="text">
    			 
                <p class="contact"><label for="city">City</label></p> 
    			<input type="text" id="city" name="city" required="" placeholder="Aberdeen">
                <p class="contact"><label for="state">State</label></p> 
    			<input type="text" id="state" name="state" required="" placeholder="Aberdeen">
